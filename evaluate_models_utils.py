...
def evaluate_model_link_prediction(model_name: str, model: nn.Module, neighbor_sampler: NeighborSampler, evaluate_idx_data_loader: DataLoader,
    ...
    with torch.no_grad():
        ...
        for batch_idx, evaluate_data_indices in enumerate(evaluate_idx_data_loader):
            ...
            evaluate_metrics.append(get_link_prediction_metrics(predicts=predicts, labels=labels, num_pos=len(positive_probabilities)))
...
def evaluate_model_retrival(model_name: str, model: nn.Module, neighbor_sampler: NeighborSampler, evaluate_idx_data_loader: DataLoader,
    ...
    with torch.no_grad():
        ...
        for batch_idx, evaluate_data_indices in enumerate(evaluate_idx_data_loader):
            ...
            print(batch_src_node_ids, batch_neg_dst_node_ids[0])
    ...
    for run in range(args.num_runs):
        ...
        for batch_idx, test_data_indices in enumerate(test_idx_data_loader_tqdm):
            ...
            if test_neg_edge_sampler.negative_sample_strategy != 'random':
                ...
                _, all_batch_neg_dst_node_ids = test_neg_edge_sampler.sample(size=len(batch_src_node_ids))
            batch_neg_src_node_ids = batch_src_node_ids
            ...
            negative_edges = [(batch_src_node_ids, all_batch_neg_dst_node_ids)]
